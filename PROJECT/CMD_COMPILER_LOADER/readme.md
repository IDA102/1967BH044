***Проект toolchain для создания 'x.dxe' фаила из исходного текста c использованием makefile, загрузки в DSP с использование 'x.bat'. Организации работы из MatLab.***
